...
| `ModShark.Reporters.Post.IncludeFlags`               | Boolean  | Whether the flagged text should be included in the post.<br/>Note: MFM cannot be escaped to safely render untrusted text.<br/>Default: `false`                                                                                                                                                                                                     |
...
| `ModShark.Reporters.SendGrid.IncludeFlags`           | Boolean  | Whether to include the flagged text in the report.<br/>Default: `true`                                                                                                                                                                                                                                                                             |
...
| `ModShark.Reporters.WebHook.Hooks.IncludeFlags`      | Boolean  | Whether to include the flagged text in the report.<br/>Default: `true`                                                                                                                                                                                                                                                                             |
