...
builder.Services.AddSingleton(config.Reporters.WebHook);
...
builder.Services.AddScoped<IDiscordPublisher, DiscordPublisher>();
builder.Services.AddScoped<IWebHookReporter, WebHookReporter>();
